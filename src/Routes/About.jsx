...
import {Box,VStack,Image,Stack,Text } from '@chakra-ui/react'
...
const About = () => {
  ...
  return (
    <Box  width={["100%","80%"]} margin="auto" name="About" mt="5%" padding="6%" >
      ...
      <Stack justifyContent="space-around" alignItems="center" direction={{ lg: "row",xl:"row", md: "column-reverse",base:"column-reverse"   }} spacing="50px">
