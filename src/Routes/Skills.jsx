  ...
  return (
    <div name="Skills"  padding="5%" >
      ...
      <div id="skill" style={{display:"grid",marginTop:"0%",gridTemplateColumns:"repeat(auto-fit,minmax(150px,min-content))",justifyContent:"center",gap:"2%",width:"80%",margin:"auto"}}>
        <div data-aos="fade-right"  style={{width:"120px",borderRadius:"15px",height:"140px",marginLeft:"5%",padding:"10%",cursor:"pointer",color:colorMode=="light"?"black":"white"}}>
        ...
        <div data-aos="fade-right" style={{width:"120px",borderRadius:"15px",height:"140px",marginLeft:"5%",padding:"10%",cursor:"pointer",color:colorMode=="light"?"black":"white"}}>
          <img src="/projects-img/vue.png" alt="" />
          <p>Vue.js</p>
        </div>
        <div data-aos="fade-right" style={{width:"120px",borderRadius:"15px",height:"140px",marginLeft:"5%",padding:"10%",cursor:"pointer",color:colorMode=="light"?"black":"white"}}>
          <img src="/projects-img/nextjs.png" alt="" />
          <p>Next.js</p>
        </div>
        <div data-aos="fade-right" style={{width:"120px",borderRadius:"15px",height:"140px",marginLeft:"5%",padding:"10%",cursor:"pointer",color:colorMode=="light"?"black":"white"}}>
        ...
        <div data-aos="fade-left" style={{width:"120px",borderRadius:"15px",height:"140px",marginLeft:"5%",padding:"10%" ,cursor:"pointer",color:colorMode=="light"?"black":"white"}}>
      ...
      <div data-aos="fade-right" style={{width:"120px",borderRadius:"15px",height:"140px",marginLeft:"5%",padding:"10%" ,cursor:"pointer",color:colorMode=="light"?"black":"white"}}>
        ...
        <div data-aos="fade-right" style={{marginBottom:"40%",width:"120px",borderRadius:"15px",height:"140px",marginLeft:"5%",padding:"10%",cursor:"pointer",color:colorMode=="light"?"black":"white"}}>
