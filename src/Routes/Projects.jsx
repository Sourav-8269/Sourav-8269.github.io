...
import {SiJavascript,SiVuedotjs,SiQuasar} from "react-icons/si";
import AOS from "aos";
    ...
    <div  >
     ...
     data-aos-anchor-placement="bottom-center">MY PROJECTS</Heading>
      <Stack direction={{ lg: "row",xl:"row","2xl":"row", md: "column",base:"column",sm:"column" }} spacing="50px">
        {/* center */}
      <Box>
        <Box data-aos="fade-up" data-aos-duration="1000"  data-aos-easing="linear" id="projectDiv" borderRadius="15px"  padding="2%"  mb={10} >
        ...
        <Heading as="p" size="xs" id="projectText">Adorama is a e-commerce website which provides DSLR cameras, 4K video gear, and Home Electronics like the latest Smart Home devices.</Heading>
      ...
      <Box>
        <Box data-aos="fade-up" data-aos-duration="1000"  data-aos-easing="linear" id="projectDiv" borderRadius="15px"  padding="3%" mb={10} >
        ...
        <Heading as="p" size="xs" id="projectText">KFC is an American fast food restaurant chain headquartered in Louisville, Kentucky, that specializes in fried chicken.</Heading>
          <HStack m={5} justifyContent="space-around" >
          {/* <a href="http://" target="_blank" rel="noopener noreferrer"><FaVideo size="40px"/></a> */}
